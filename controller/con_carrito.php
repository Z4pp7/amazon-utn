...
$compra = new Mod_Compra();
  ...
  if(isset($_POST['opcion'])){
    ...
    switch ($_POST['opcion']) {
      ...
      header('Location: http://localhost/amazon-utn/view/producto/producto.php');

    }else{
        header('Location: http://localhost/amazon-utn/view/tienda/ingresar.php');
    }
      ...
      case 'detalle':
          ...
          header('Location: http://localhost/amazon-utn/view/producto/detalle.php');
      ...
      header('Location: http://localhost/amazon-utn/view/producto/filtrado.php');
      break;
